...
public class MyTalksActivity extends ActionBarActivity {

    private List<Talks.Talk> talks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        talks = new Talks().getTalks(getApplicationContext());
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view,
                ...
                i.putExtra("first", talks.get(position).firstValue);
                i.putExtra("second", talks.get(position).secondValue);
                i.putExtra("id", talks.get(position).talkId);
                i.putExtra("uri", talks.get(position).uri);
                i.putExtra("downloaded", talks.get(position).downloadValue);
